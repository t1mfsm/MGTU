...
code segment	'code'
	...
	; данные
	replaceWith 				DB	'йцукенгшщзхъфывапролджёячсмитьбюqwertyuiopasdfghjklzxcvbnm' ; список игнорируемых символов
	ignoredChars                DB  'ЙЦУКЕНГШЩЗХЪФЫВАПРОЛДЖЁЯЧСМИТЬБЮQWERTYUIOPASDFGHJKLZXCVBNM'
	...
	translateTo 					DB	'ЛМНОП'	; символы на которые будет идти замена'	; символы на которые будет идти замена
...
cursiveSymbol         DB 00000000b ; символ, составленный из единичек (его курсивный вариант)
	...
	signatureLine1				DB	179, 'Шакиров Тимур                                      ', 179          
	...
	helpMsg DB '>tsr.com [/?] ', 10, 13
					...
					DB ' unloader.com запрос (Y или N ) - выгрузка резидента из памяти', 10, 13
					DB '  F6  - вывод ФИО и группы по таймеру в низ экрана', 10, 13
					DB '  F7  - включение и отключения курсивного вывода русского символа П', 10, 13
					DB '  F8  - включение и отключение частичной русификации клавиатуры(KVYJG -> ЛМНОП)', 10, 13
					DB '  F9  - включение и отключение режима замены Прописных на строчные', 10, 13
